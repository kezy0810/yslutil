 ...
 * @class_Name CNNMFilter.java
 * @author liubang
 * @date 2015-8-27 下午6:02:37
 * @version v1.0
 */
...
public class CNNMFilter {
    ...
    public static int cnNumericToArabic( String cnn, boolean flag ) {
    	String str = StringUtils.join(CN_NUMERIC);
    	char[] chrCharArray = cnn.toCharArray();
    ...
    public static void main(String[] args) {
		System.out.println(CNNMFilter.cnNumericToArabic("第区域管理部",false));
	}
}
