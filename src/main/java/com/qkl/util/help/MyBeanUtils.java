...
//          String type = origDescriptors[i].getPropertyType().toString();
  ...
  /**
 	 ...
 	 * copy
 	 */
   public static void copyBeanNotNull2Bean1(Object databean,Object tobean)throws Exception
   {
 	  PropertyDescriptor origDescriptors[] =
           PropertyUtils.getPropertyDescriptors(databean);
       for (int i = 0; i < origDescriptors.length; i++) {
...
//           String type = origDescriptors[i].getPropertyType().toString();
           ...
           if (PropertyUtils.isReadable(databean, name) &&
               PropertyUtils.isWriteable(tobean, name.substring(0,name.length()-1))) {
               try {
                   Object value = PropertyUtils.getSimpleProperty(databean, name);
                   if(value!=null){
                 	    copyProperty(tobean, name.substring(0,name.length()-1), value);
                   }
               }
               catch (java.lang.IllegalArgumentException ie) {
                   ; // Should not happen
   ...
   /**
	 ...
	 * copy
	 */
  public static void copyBeanNotNull2Bean2(Object databean,Object tobean)throws Exception
  {
	  PropertyDescriptor origDescriptors[] =
          PropertyUtils.getPropertyDescriptors(databean);
      for (int i = 0; i < origDescriptors.length; i++) {
...
//          String type = origDescriptors[i].getPropertyType().toString();
          ...
          if (PropertyUtils.isReadable(databean, name) &&
              PropertyUtils.isWriteable(tobean, name+"1")) {
              try {
                  Object value = PropertyUtils.getSimpleProperty(databean, name);
                  if(value!=null){
                	    copyProperty(tobean, name+"1", value);
                  }
              }
              catch (java.lang.IllegalArgumentException ie) {
                  ; // Should not happen
