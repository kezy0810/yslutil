 ...
 *
 */
public class Page_bk implements Serializable {
  private static final long serialVersionUID = 1L;
     ...
     * @param pageSize 页大小
     */
    public Page_bk(int count, int currentPage, int pageSize) {
        this.count = count;
     ...
     * @param currentPage 当前页
     */
    public Page_bk(int count, int currentPage) {
        this.count = count;
        this.currentPage = currentPage;
    }
    ...
    public static void main(String args[]) {
        Page_bk pageutil = new Page_bk(30);
