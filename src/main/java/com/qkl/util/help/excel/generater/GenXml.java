...
public class GenXml extends JFrame {
	...
	private ActionListener doneListener = new ActionListener() {
		public void actionPerformed(ActionEvent e) {
			...
			try {
				...
				if (JOptionPane.showConfirmDialog(GenXml.this, "保存完成，是否退出向导?",
						"成功", JOptionPane.OK_CANCEL_OPTION) == JOptionPane.OK_OPTION) {
					System.exit(0);
				}
			} catch (Exception e2) {
	...
	private void ReadInTable(String clasz) {
		...
		try {
			...
			JOptionPane
					.showMessageDialog(GenXml.this, "发生错误:" + e.getMessage());
		}
	}
}
