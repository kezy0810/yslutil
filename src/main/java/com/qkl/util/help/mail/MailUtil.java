...
//        message.setRecipient(MimeMessage.RecipientType.CC, new InternetAddress("kezar10@163.com", "USER_EE", "UTF-8"));
       ...
       /* // 4. Subject: 邮件主题
        ...
        message.setContent("Java Code Test Send Email", "text/html;charset=UTF-8");*/
        // 4. Subject: 邮件主题
     ...
     * @param from 发送者
     * @param to 接收者
     * @param password 授权密码，需在邮箱网站->设置 中获取
     * @return: void
     */
    public static void mailSend(String subject,String content,String from,String to,String password){
        // 1. 创建参数配置, 用于连接邮件服务器的参数配置
        Properties props = new Properties();                    // 参数配置
        props.setProperty("mail.transport.protocol", "smtp");   // 使用的协议（JavaMail规范要求）
        props.setProperty("mail.smtp.host", myEmailSMTPHost);   // 发件人的邮箱的 SMTP 服务器地址
